/**
 * Detección de idioma del navegador para redirección automática
 * Solo se ejecuta en la primera visita si no hay preferencia guardada
 */
(function() {
  ...
  // No necesitamos esperar al DOM ya que solo leemos window.location
  detectAndRedirect();
})();
